...
#include "mks/mks_all_axes_control_workspace/mks_all_axes_control_workspace.h"
...
MainWindow::MainWindow(
    ...
    manager_ = new mks::AxisManager(host_service);
